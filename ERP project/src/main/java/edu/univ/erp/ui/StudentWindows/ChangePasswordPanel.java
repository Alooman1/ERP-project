...
public class ChangePasswordPanel extends JPanel {
    ...
    public ChangePasswordPanel(UserSession session) {
        ...
        // Main form panel that holds all input fields
        ...
        // Create all password fields with labels
    ...
    // Create password field with dark theme
    ...
    // Create password field with show/hide eye button
